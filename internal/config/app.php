...
return [
    ...
    'base_url' => getenv('APP_BASE_URL') ?: 'http://localhost:8083',
    ...
    'smtp_tls_server_name' => getenv('SMTP_TLS_SERVER_NAME') ?: '',
    'smtp_tls_verify' => filter_var(getenv('SMTP_TLS_VERIFY') ?: 'true', FILTER_VALIDATE_BOOLEAN),
    'smtp_auth_mode' => strtolower((string) (getenv('SMTP_AUTH_MODE') ?: 'auto')),
    'smtp_auth_optional' => filter_var(getenv('SMTP_AUTH_OPTIONAL') ?: 'false', FILTER_VALIDATE_BOOLEAN),
