<section class="panel" id="hr-roles-page">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-2">
        <h2 class="mb-0"><i class="fas fa-user-tag me-2" style="color: #008AC4;"></i>Manage Assignment Roles</h2>
        <div class="d-flex gap-2">
            ...
            <a href="/hr/personnel-roles" class="btn" style="border:1px solid #008AC4; color:#008AC4;">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted small mb-3">
                    ...
                    Assignment roles are used to route and assign cases by responsibility area.
                </p>
