        ...
        <div id="tab-new" class="tab-pane fade show active" role="tabpanel">
            <form id="new-feedback-form" enctype="multipart/form-data" class="mt-3">
                ...
                <div class="mb-3">
                    ...
                    <small id="description-counter" class="form-text text-muted">0 / 5000 characters</small>
                ...
                <div class="col-lg-6">
                    ...
                    <form id="followup-form" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <small id="followup-counter" class="form-text text-muted">0 / 5000 characters</small>
                        </div>
                        <div class="mb-3">
