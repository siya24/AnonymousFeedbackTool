<section class="panel" id="hr-statuses-page">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-2">
        <h2 class="mb-0"><i class="fas fa-stream me-2" style="color: #3f4f6a;"></i>Manage Statuses</h2>
        <div class="d-flex gap-2">
            <a href="/hr" class="btn btn-outline-secondary">
                <i class="fas fa-arrow-left me-1"></i>Back to HR Console
            </a>
            <a href="/hr/categories" class="btn btn-outline-primary">
    ...
    <div id="hr-statuses-section" class="mt-3">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #3f4f6a; color: white;">
                <h5 class="mb-0"><i class="fas fa-stream me-2"></i>Statuses</h5>
                <button id="status-add-btn" class="btn btn-sm btn-light"><i class="fas fa-plus me-1"></i>Add Status</button>
            </div>
            <div class="card-body">
                <div id="status-add-form" class="d-none mb-3 p-3" style="background:#f8f9fa;border-radius:6px;">
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-3 d-flex gap-2">
                            <button id="status-save-btn" class="btn btn-primary flex-grow-1"><i class="fas fa-save me-1"></i>Save</button>
                            <button id="status-cancel-btn" class="btn btn-secondary">Cancel</button>
                        </div>
                    </div>
                </div>
